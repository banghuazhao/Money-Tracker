...
class CalculatorsViewController: UIViewController {
    private let items: [CalculatorItem] = [
        ...
        CalculatorItem(
            ...
            subtitle: "Monthly saving to reach a target".localized(),
            icon: UIImage(systemName: "target"),
            color: .systemPurple
        ),
        CalculatorItem(
            title: "Retirement".localized(),
            subtitle: "Project your retirement nest egg".localized(),
            icon: UIImage(systemName: "figure.walk"),
            color: .systemTeal
        ),
        CalculatorItem(
            title: "Debt Payoff".localized(),
            subtitle: "Time and interest to clear a debt".localized(),
            icon: UIImage(systemName: "creditcard.fill"),
            color: .systemRed
        ),
        CalculatorItem(
            title: "Tip Calculator".localized(),
            subtitle: "Split the bill and tip".localized(),
...
extension CalculatorsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 3:
            navigationController?.pushViewController(SavingsGoalCalculatorViewController(), animated: true)
        case 4:
            navigationController?.pushViewController(RetirementCalculatorViewController(), animated: true)
        case 5:
            navigationController?.pushViewController(DebtPayoffCalculatorViewController(), animated: true)
        case 6:
            navigationController?.pushViewController(TipCalculatorViewController(), animated: true)
        default:
            break
        }
    }
